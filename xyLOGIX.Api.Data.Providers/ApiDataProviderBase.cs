...
namespace xyLOGIX.Api.Data.Providers
{
    ...
    public abstract class
        ApiDataProviderBase<T> : IApiDataProvider<T> where T : class
    {
        /// <summary>
        /// Constructs a new instance of <see
        /// cref="T:PortfolioMonitor.Investments.ApiDatasetProviderBase"/> and
