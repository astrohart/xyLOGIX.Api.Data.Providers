...
namespace xyLOGIX.Api.Data.Providers
{
        ...
        where T : class
    {
        ...
        /// <see
        ///     cref="T:PortfolioMonitor.Investments.ApiDatasetProviderBase" />
        /// and
        ...
        /// Thrown if the required parameter, <paramref name="repository" />, is
        ...
        /// Constructs a new instance of
        /// <see
        ///     cref="T:xyLOGIX.Api.Data.Providers.ApiDataProviderBase" />
        /// and
        /// returns a reference to it.
        /// </summary>
        /// <remarks>
